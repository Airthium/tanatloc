...
const Project = (): JSX.Element => {
  ...
  return (
    <Card title="Project">
      ...
      <Typography.Title level={5}>Archive Project</Typography.Title>
      <Typography.Text>
        You can archive a project to save disk space.
        <br />
        Once archived, a project is not editable anymore.
        <br />
        At the archive time, you can download a <code>
          .tanatlocarchive
        </code>{' '}
        file that contains all the data to restore your project later.
        <br />
        ...
        <ul>
          ...
          <li>
            Delete the archive file on the server, in the case you will not be
            able to restore the project from the server archive file.
          </li>
        </ul>
      </Typography.Text>
    </Card>
