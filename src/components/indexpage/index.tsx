      ...
      <Layout.Content className="Index-Content">
        ...
        <div className="display-flex-between margin-element Index2-plugins">
          <div className="width-50">
            <img src="images/indexpage/capture-a-changer.png" alt="tanatloc" />
          </div>
          ...
          <div className="width-40">
            ...
            >
              <div className="text-center width-30">
                <img src="images/indexpage/logo-rescale.png" alt="rescale" />
                <h3>Rescale</h3>
                <h5>Paid Feature</h5>
                <h6>Contact us</h6>
              </div>
              <div className="text-center width-30">
                <img src="images/indexpage/logo-argo.png" alt="argo" />
                <h3>Argo-graph sharetask</h3>
                <h5>Paid Feature</h5>
                <h6>Contact us</h6>
              </div>
              <div style={{ textAlign: 'center', width: '30%' }}>
                <img src="images/indexpage/logo-slurm.png" alt="slurm" />
                <h3>Slurm</h3>
                <h5>Upcoming</h5>
              </div>
              <div style={{ textAlign: 'center', width: '30%' }}>
                <img src="images/indexpage/logo-qarnot.png" alt="qarnot" />
